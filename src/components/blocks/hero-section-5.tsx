                            ...
                            <div className="relative py-6 md:w-[calc(100%-15rem)]">
                                <InfiniteSlider
                                    ...
                                    {[
                                        ...
                                        "/src/assets/images/regenerated_image_1777871487516.webp",
                                        "/src/assets/images/regenerated_image_1777872551437.png",
                                        "/src/assets/images/regenerated_image_1777872798321.png",
                                    ].map((src, idx) => (
